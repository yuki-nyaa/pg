...
struct Token_Settings{
    ...
    struct Token_Kind{
        enum enum_t : Token_Kind_t {X,Y,Z,a,c,d,EOF_,};
    };
    static constexpr const char* token_name[token_total] = {"X","Y","Z","a","c","d","EOF_",};

    static constexpr Token_Kind_t nterminal_first = Token_Kind::X;
    static constexpr Token_Kind_t nterminal_last = Token_Kind::Z;
    ...
    static constexpr size_t nterminal_total = 3;
    static constexpr size_t terminal_total = 4;
