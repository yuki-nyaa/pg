...
namespace xxx{
constinit yuki::pg::LR1_Action_Table<Token_Settings,12,5> SParser_Tables::action_table = {
    {0,2,{1,3}},
    {1,2,{1,3}}, {1,4,{2,0}},
    {2,2,{2,2}}, {2,4,{2,2}},
    {3,2,{1,6}}, {3,3,{1,7}},
...
template<int I>
int SParser<I>::parse(Lexer& lexer_p_){
...
template int SParser<0>::parse(Lexer&);
template int SParser<1>::parse(Lexer&);
template int SParser<2>::parse(Lexer&);
} // namespace xxx