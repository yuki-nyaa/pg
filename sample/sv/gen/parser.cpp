    ...
    while(true){
        ...
        switch(art_.rule){
            case 2:{ // List -> Pair
                ...
                size_t& token0_ = stack_[start_+0].token.get<1>();
                ...
                std::list<size_t>& token_target_ = token_target_complete_.get<2>();
         ...
         token_target_.push_back(1);
            ...
            case 1:{ // List -> List Pair
                ...
                std::list<size_t>& token0_ = stack_[start_+0].token.get<2>();
                size_t& token1_ = stack_[start_+1].token.get<1>();
         ...
         token_target_.push_back(2);
            ...
            case 4:{ // Pair -> "(" ")"
                ...
                size_t& token_target_ = token_target_complete_.get<1>();
