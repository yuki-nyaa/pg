...
#ifdef YUKI_PG_DBG_ANY_TTOKEN_DTOR
#define YUKI_PG_DBGO_ANY_TTOKEN_DTOR(...) YUKI_PG_DBGO(__VA_ARGS__)
#else
#define YUKI_PG_DBGO_ANY_TTOKEN_DTOR(...)
#endif

#ifdef YUKI_PG_DBG_ANY_TTOKEN_MOVE_ASSIGN
#define YUKI_PG_DBGO_ANY_TTOKEN_MOVE_ASSIGN(...) YUKI_PG_DBGO(__VA_ARGS__)
#else
#define YUKI_PG_DBGO_ANY_TTOKEN_MOVE_ASSIGN(...)
#endif
